 ...
 */
var bottomPourSql = {
    insert:'INSERT INTO bottom_pour_record(user_id,play_type,bottom_pour_money,bottom_pour_type,bottom_pour_number,serial_number,room_id,lottery_place_type) VALUES(?,?,?,?,?,?,?,?)',
